...
export default function ContactForm({
  defaultService = "Architecture Planning",
  minimal = false
}: {
  ...
  const FormContent = (
    <div className="framed-print">
      <form onSubmit={handleSubmit} className="p-6 md:p-8 lg:p-12 space-y-12 text-left">
        ...
        <div className="flex flex-col gap-4 text-left font-light">
        ...
        <div className="pt-6 relative text-left">
          <button
            type="submit"
